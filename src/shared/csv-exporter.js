/**
 * APEX Telemetry CSV Exporter
 * Formats stint and lap telemetry streams into standardized, RFC-4180 compliant CSV strings
 * for export to MoTeC i2 Pro, TrackAddict, Excel, and third-party data analysis software.
 */

import { mpsToMph, mpsToKmh } from './telemetry-types.js';

export class TelemetryCsvExporter {
  /**
   * Generates a CSV formatted string from an array of APEX TelemetryData samples
   * @param {Array<Object>} samples Telemetry sample frames
   * @param {Object} options Formatting and metadata options
   * @returns {string} CSV string
   */
  static exportToCsv(samples = [], options = {}) {
