...
export const FM23_TRACKS = [
  ...
  // Fictional Tracks
  {
    ...
    type: 'Fictional',
    layouts: [
      { name: 'Club Circuit', length: '~2.5 km' },
      { name: 'Club Circuit Reverse', length: '~2.5 km' },
      { name: 'Oval Circuit', length: '~1.6 km' }
    ]
  },
  {
    name: 'Fujimi Kaido',
    type: 'Fictional',
    layouts: [
      { name: 'Full Circuit', length: '~5.0 km' },
      { name: 'Full Circuit Reverse', length: '~5.0 km' }
    ]
  },
  {
    ...
    layouts: [
      { name: 'National Circuit', length: '~3.5 km' },
      { name: 'Club Circuit', length: '~2.5 km' },
      { name: 'National Circuit Reverse', length: '~3.5 km' }
    ]
  },
  {
    name: 'Hakone Circuit',
    type: 'Fictional',
    layouts: [
      { name: 'Grand Prix Circuit', length: '~4.5 km' },
      { name: 'Club Circuit', length: '~2.5 km' },
      { name: 'Club Circuit Reverse', length: '~2.5 km' }
    ]
  },
  {
    ...
    type: 'Fictional',
    layouts: [
      { name: 'Full Circuit', length: '~3.5 km' },
      { name: 'Short Circuit', length: '~2.5 km' },
      { name: 'Short Circuit Reverse', length: '~2.5 km' }
    ]
  },
  {
    ...
    type: 'Fictional',
    layouts: [
      { name: 'Full Circuit', length: '~4.5 km' },
      { name: 'Full Circuit Reverse', length: '~4.5 km' },
      { name: 'Club Circuit', length: '~2.5 km' },
      { name: 'Club Circuit Reverse', length: '~2.5 km' },
      { name: 'Speedway', length: '~2.5 km' }
    ]
  }
];
